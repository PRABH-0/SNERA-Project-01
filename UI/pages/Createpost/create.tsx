  ...
  return (
    <>
      ...
      "
        >
          ...
          <div className="mb-[30px] pb-[20px] border-b border-[var(--border-color)]">
            <h2 className="text-[20px] font-semibold mb-4 text-[var(--text-primary)] flex items-center gap-2">
              <svg className="w-6 h-6 fill-[var(--accent-color)] rounded-sm ">
            ...
            ></textarea>
            <div className="text-[12px] my-2.5">
          ...
          <div className="mb-[30px] pb-[20px] border-b border-[var(--border-color)]">
            ...
            {/* Skills Need */}
            <label className="font-semibold text-[14px] mt-6 block">
              Skills I Need
            </label>
            <div className="flex flex-wrap gap-2 mt-2">
              ...
              <div className="grid grid-cols-1 gap-3 md:grid-cols-3 ">
                {[
                  ...
                  return (
                    <label
                      key={status.value}
                      className={`flex cursor-pointer items-center gap-3 rounded-lg border-2 bg-[var(--bg-tertiary)] text-[var(--text-primary)] px-4 py-3 text-sm transition ${
        ...
        {/* Preview Section */}
        <div
          className="mb-8 rounded-xl bg-[var(--card-bg)]  shadow-[var(--card-shadow)]
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-sm font-medium">
                      {form.project_Timeline
                        ? `${form.project_Timeline} hrs/week`.replace(
                            "flexible hrs/week",
                            "Flexible"
                          )
                        : "Not specified"}
