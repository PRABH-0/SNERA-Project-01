...
namespace Snera_Core.Migrations
{
    ...
    [Migration("20260124082629_add_conversation_id_in_UserProjects_Table")]
    partial class add_conversation_id_in_UserProjects_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectDeveloperRequestSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<Guid>("DeveloperRequest_Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DeveloperRequest_Id");

                    b.ToTable("ProjectDeveloperRequestSkill");
                });

            modelBuilder.Entity("Snera_Core.Entities.ChatEntities.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Snera_Core.Entities.ChatEntities.ConversationParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("Joined_Timestamp")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Snera_Core.Entities.ChatEntities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("Sent_Timestamp")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Snera_Core.Entities.ChatEntities.UserConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime>("Connected_Timestamp")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Snera_Core.Entities.UserEntities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Snera_Core.Entities.UserEntities.UserLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Snera_Core.Entities.UserEntities.UserPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Snera_Core.Entities.UserEntities.UserProfileDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjectDeveloperRequestSkill", b =>
                {
                    b.HasOne("Snera_Core.Entities.ProjectEntities.ProjectDeveloperRequest", "DeveloperRequest")
                        .WithMany("ProjectDeveloperRequestSkill")
                        .HasForeignKey("DeveloperRequest_Id")
            ...
            modelBuilder.Entity("Snera_Core.Entities.ChatEntities.ConversationParticipant", b =>
                {
                    b.HasOne("Snera_Core.Entities.ChatEntities.Conversation", null)
            ...
            modelBuilder.Entity("Snera_Core.Entities.ProjectEntities.ProjectDeveloperRequest", b =>
                {
                    b.Navigation("ProjectDeveloperRequestSkill");
                });
